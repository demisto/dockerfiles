...
def main():
    ...
    print(cyan('Starting the slack notifier'))
    ...
    if pr.user.login == 'xsoar-bot':
        print(cyan('PR was created using the XSOAR-UI, support will be community. Not sending a slack message '))
