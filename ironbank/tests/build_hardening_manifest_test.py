...
def test_resource_handling():
    ...
    hardening_manifest = HardeningManifest('', '', 'test_data/docker_packages_metadata.txt')
...
def test_integration():
    temp_dir = mkdtemp()
    hardening_manifest = HardeningManifest('test_data/netmiko', f'{temp_dir}/hardening_manifest.yaml', 'test_data/docker_packages_metadata.txt')
